...
class CustomTrainer(Trainer):
    ...
    def on_epoch_end(self):
        ...
        model_path = os.path.join(modelfolder, f"{modelname_str}_{NUM_BATCHES}_batches_{NUM_EPOCHS}_epochs_{timestamp}_epoch_{int(epoch)}")
...
# Save the fine-tuned model with the specified naming format
model_path = os.path.join(modelfolder, f"{modelname_str}_{NUM_BATCHES}_batches_{NUM_EPOCHS}_epochs_{timestamp}")
